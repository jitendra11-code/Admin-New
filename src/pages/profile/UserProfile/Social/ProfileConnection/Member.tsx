...
import AppCard  from "@uikit/core/AppCard";
import { alpha, Avatar, Box, Typography } from "@mui/material";
import Button from "@mui/material/Button";
import { Fonts } from "../../../../../shared/constants/AppEnums";
import { MemberData } from "@uikit/services/db/profile";
  ...
  return (
    <AppCard
      ...
      sxStyle={{
        boxShadow: "none",
        borderRadius: 1,
        border: (theme: AdminERPTheme) => `solid 1px ${theme.palette.divider}`,
        height: "100%",
      }}
      titleStyle={{
        fontSize: 12,
        fontWeight: Fonts.SEMI_BOLD,
        color: (theme: AdminERPTheme) => theme.palette.text.secondary,
      }}
    >
      {connect ? (
        <Box sx={{ mb: 2 }}>
