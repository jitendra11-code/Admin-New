                    ...
                    >
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell className="w-50" >{onAssetDrawerData?.assetCategorisation}</TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                          ...
                          <TableCell className="w-50" >{onAssetDrawerData?.asset_description}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="field-bold w-50">PAV Location</TableCell>
                          <TableCell className="w-50" >{onAssetDrawerData?.paV_Location}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="field-bold w-50">Book Value</TableCell>
                          <TableCell className="w-50" >{onAssetDrawerData?.book_val}</TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                          ...
                          <TableCell className="w-50" >{moment(new Date(onAssetDrawerData?.cap_date)).format('DD/MM/YYYY')}</TableCell>
                        </TableRow>
