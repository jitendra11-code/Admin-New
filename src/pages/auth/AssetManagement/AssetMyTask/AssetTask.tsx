      ...
      <Grid sx={{ display: 'flex', alignItems: "center", justifyContent: "flex-start", marginBottom: "5px" }}>
        <Button >
          <Card
            ...
            className={module === "Asset Inward" ? "BoxOuter active" : "BoxOuter"}
          >
        ...
        <Button  >
          <Card
            ...
            className={module === "Asset Insurance" ? "BoxOuter active" : "BoxOuter"}
          >
            <Badge badgeContent={100} color="secondary" style={{marginTop:"-60px", right:"22px", borderRadius:"-6px"}}></Badge>
              <Typography>
                Asset Insurance
        ...
        <Button  >
          <Card
            ...
            className={module === "Asset Tagging" ? "BoxOuter active" : "BoxOuter"}
          >
            <Badge badgeContent={100} color="secondary" style={{marginTop:"-60px", right:"22px", borderRadius:"-6px"}}></Badge>
            <Typography>
              Asset Tagging
        ...
        <Button  >
          <Card
            ...
            className={module === "Asset PAV" ? "BoxOuter active" : "BoxOuter"}
          >
            <Badge badgeContent={100} color="secondary" style={{marginTop:"-60px", right:"22px", borderRadius:"-6px"}}></Badge>
            <Typography>
              Asset PAV
        ...
        <TabContext value={value}>
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            <TabList onChange={handleChange} aria-label="lab API tabs example">
              <Tab  label="Asset Request" value="1" />
              <Tab  label="Quotations" value="2"  />
              <Tab  label="Gate Pass & Gate Inward" value="3" />
              <Tab  label="Transfer Review & Closer " value="4" />
