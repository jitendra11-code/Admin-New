...
//   });
  const moduleValue = "Asset Management";
...
// console.log('menuList',menuList)
  useEffect(() => {
      if (moduleValue == "Asset Management") {
        getMenuList();
      } 
      ...
      >
        ...
        <Button disabled = {arrayModuleList.includes("Asset Management") == false}> 
          <Card
            ...
            className={moduleValue === "Asset Management" || (defaultModule == "Asset Management" && moduleValue === "")? "BoxOuter active" : "BoxOuter"}
          >
            <Typography>
              Asset <br />
              Management
        ...
        <Button disabled = {arrayModuleList.includes("Branch Master") == false}> 
          <Card
            ...
            className={
              // (defaultModule == "Branch Onboarding" && moduleValue === "") || moduleValue ==="Branch Onboarding"|| 
          location?.pathname == "/home/Branch_Master"
                    ? "BoxOuter active" : "BoxOuter" }
          >
            <Typography>
             Branch <br />
        ...
        <Button disabled = {arrayModuleList.includes("Reports") == false}>
          <Card
            ...
            className={
                // (defaultModule == "Reports" && moduleValue === "") || moduleValue ==="Reports"|| 
