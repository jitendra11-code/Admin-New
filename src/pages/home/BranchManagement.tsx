...
//   });
  const moduleValue = "Branch Management";
  ...
  useEffect(() => {
      if (moduleValue == "Branch Management") {
        getMenuList();
      } 
  }, [moduleValue])
      ...
      >
        <Button disabled = {arrayModuleList.includes("Branch Management") == false}>
          <Card
            ...
            //   navigate("/home/Branch_Management_Home");
              // getMenuList();
            }}
            className={moduleValue === "Branch Management" || (defaultModule == "Branch Management" && moduleValue === "")? "BoxOuter active" : "BoxOuter"}
          >
            <Typography>
              Branch <br />
              Management
