...
//   });
  const moduleValue = "Branch Master";
  ...
  const getMenuList = async () => {
    ...
    await axios
      .get(`${process.env.REACT_APP_BASEURL}/api/RoleMenuList/RoleMenuList?module=${moduleValue}`)
      .then((response) => {
      ...
      >
        <Button disabled = {arrayModuleList.includes("Branch Management") == false}>
          <Card
            ...
            className={
                // moduleValue === "Branch Management" || (defaultModule == "Branch Management" && moduleValue === "")|| 
                location?.pathname == "/home/Branch_Management"
            ? "BoxOuter active" : "BoxOuter"}
          >
            <Typography>
              Branch <br />
              Management
        ...
        <Button disabled = {arrayModuleList.includes("Branch Onboarding") == false}>
          <Card
            ...
            className={
                // (defaultModule == "Branch Onboarding" && moduleValue === "") || moduleValue ==="Branch Onboarding"|| 
            location?.pathname == "/home/Branch_Onbording"
                      ? "BoxOuter active" : "BoxOuter" }
            >
        ...
        <Button disabled = {arrayModuleList.includes("Asset Management") == false}> 
          <Card
            ...
            className={
              // (defaultModule == "Branch Onboarding" && moduleValue === "") || moduleValue ==="Branch Onboarding"|| 
          location?.pathname == "/home/Asset_Management"
                    ? "BoxOuter active" : "BoxOuter" }
          >
            <Typography>
              Asset <br />
        ...
        <Button disabled = {arrayModuleList.includes("Branch Master") == false}> 
          <Card
            ...
            onClick={() => {
              // navigate("/home/Asset_Management_Home");
              navigate("/home/Branch_Master");
            //   setModule("Branch Master")
            }}
            className={moduleValue === "Branch Master" || (defaultModule == "Branch Master" && moduleValue === "")? "BoxOuter active" : "BoxOuter"}
          >
            <Typography>
             Branch <br />
              Master
...
export default BranchMasterManagment;
