...
//   });
  const moduleValue = "Branch Onboarding";
...
// console.log('menuList',menuList)
  useEffect(() => {
      if (moduleValue == "Branch Onboarding") {
        getMenuList();
      } 
      ...
      >
        ...
        <Button disabled = {arrayModuleList.includes("Branch Onboarding") == false}>
          <Card
            ...
            className={(defaultModule == "Branch Onboarding" ) || moduleValue ==="Branch Onboarding"
...
export default BranchOnbording;
