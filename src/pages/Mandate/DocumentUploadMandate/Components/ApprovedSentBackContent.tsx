    ...
    <>
      ...
      <div className="button-container">
        <textarea
          ...
          // size="small"
          placeholder="Remark"
          className="textAreaVertical"
          style={{ width: "500px", height: "100px", marginRight: "10px", padding: "10px" }}
          value={remark}
          // error={!remark}
...
export default ApprovedSentBackContent;
