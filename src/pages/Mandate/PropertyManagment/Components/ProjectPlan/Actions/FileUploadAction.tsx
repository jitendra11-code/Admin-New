...
const FileUploadAction = ({ params }) => {
  ...
  const handleUploadFiles = async (e, files, params) => {
    ...
    formData.append("mandate_id", params?.mandate?.id);
    formData.append("documenttype", "Project Plan");
    formData.append("CreatedBy", user?.UserName || "");
    formData.append("ModifiedBy", user?.UserName || "");
    formData.append("entityname", "Project Plan");
    formData.append("RecordId", params?.data?.planId || 0);
