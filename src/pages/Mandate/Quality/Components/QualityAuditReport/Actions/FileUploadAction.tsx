...
const MAX_COUNT = 8;
const FileUploadAction = ({ params, localData, setLocalData, selectedObj, sectionName, id, mandateId }) => {
    ...
    const handleUploadFiles = async (e, files, params) => {
        ...
        formData.append("documenttype", "Quality Audit Report");
        formData.append("CreatedBy", user?.UserName || "");
        formData.append("ModifiedBy", user?.UserName || "");
        formData.append("entityname", "Quality Audit Report");
